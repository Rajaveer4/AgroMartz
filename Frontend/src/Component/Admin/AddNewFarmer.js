...
//                     toast.success('Farmer Updated. Auto-Redirecting....',  {style: {borderRadius: '10px',background: '#333',color: '#fff',},} )
//                     setTimeout(() => {
...
//                     toast.success('Farmer Added. Auto-Redirecting....',  {style: {borderRadius: '10px',background: '#333',color: '#fff',},} )
//                     setTimeout(() => {
//                         navigate('/admin/farmer')
//                     }, 2500)
//                 })
...
//                                 <h1 className="fs-4 card-title fw-bold mb-4 text-center text-primary">{farmerId ? 'Update' : 'Add New'} Farmer</h1>
...
//                                             <textarea id="Address" className="form-control" name="Address" required rows="2" cols="50" maxLength="50"
//                                                 value={address}
