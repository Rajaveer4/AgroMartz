    ...
    const updateUser = () => {
        ...
        adminServices.updateUser(userId, data)
            .then(response => {
                ...
                toast.success('User Updated! Auto-Redirecting....',  {style: {borderRadius: '10px',background: '#333',color: '#fff',},} )
                setTimeout(() => {
    ...
    return (
        <div>
            ...
            <div className="container">
                <h3 class="my-1 mt-5 text-center text-primary fw-bold">List of Users Details</h3>
                <hr />
                <div>
