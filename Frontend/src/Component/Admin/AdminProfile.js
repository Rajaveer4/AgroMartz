    ...
    const updateUser = () => {
        ...
        adminServices.updateUser(userId, data)
            .then(response => {
                ...
                toast.success('Profile Updated! Log-In Again...', {style: {borderRadius: '10px',background: '#333',color: '#fff',},})
                            ...
                            <div className="card shadow-lg mt-5">
                                <div className="card-body px-5 pt-5">
                                    ...
                                    <div className="align-items-center d-flex">
                                        <button type="submit" className="btn btn-primary" onClick={() => navigate('/admin/')}> Go Back </button>
                                        {isDisabled ?
                                            <button type="submit" className="btn btn-success ms-auto" onClick={() => updateProfile()}> Update Profile </button>
                                            :
                                            <button type="submit" className="btn btn-success ms-auto" onClick={() => updateUser()}> Save Data </button>
                                        }
                                    </div>
