    ...
    const handleSubmit = (id) => {
        ...
        adminServices.addProductImage(formdata, id)
            .then(response => {
                ...
                toast.success('Image Uploaded. Auto-Redirecting....',  {style: {borderRadius: '10px',background: '#333',color: '#fff',},} )
                setTimeout(() => {
    ...
    const updateData = (id) => {
        ...
        adminServices.updateProduct(id, formdata)
            .then(response => {
                ...
                toast.success('Product Updated. Auto-Redirecting....',  {style: {borderRadius: '10px',background: '#333',color: '#fff',},} )
                setTimeout(() => {
                    window.location.reload();
                }, 2500)
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    >
                                        <option value="" defaultValue>Select Farmer</option>
                                        {
                                            farmers.map(f => (
                                                    ...
                                                    <div className="modal-content">
                                                        ...
                                                        <div className="modal-body">
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col">
                                                                <label class="mb-2 text-muted" for="category">Product Category</label>
